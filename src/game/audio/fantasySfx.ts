...
export const FANTASY_SFX = {
  meleeSwing: "last_summon_sfx_melee_swing",
  meleeHit: "last_summon_sfx_melee_hit",
  enemyDeath: "last_summon_sfx_enemy_death",
  playerHurt: "last_summon_sfx_player_hurt",
  chestOpen: "last_summon_sfx_chest_open",
  pickup: "last_summon_sfx_pickup",
  levelUp: "last_summon_sfx_level_up",
  woodChop1: "last_summon_sfx_wood_chop_1",
  woodChop2: "last_summon_sfx_wood_chop_2",
  woodChop3: "last_summon_sfx_wood_chop_3",
  woodChop4: "last_summon_sfx_wood_chop_4",
  mine1: "last_summon_sfx_mine_1",
  mine2: "last_summon_sfx_mine_2",
  mine3: "last_summon_sfx_mine_3",
  mine4: "last_summon_sfx_mine_4",
  footstepDirtWalk1: "last_summon_sfx_fs_dirt_w1",
  footstepDirtWalk2: "last_summon_sfx_fs_dirt_w2",
  footstepDirtWalk3: "last_summon_sfx_fs_dirt_w3",
  footstepDirtWalk4: "last_summon_sfx_fs_dirt_w4",
  footstepDirtWalk5: "last_summon_sfx_fs_dirt_w5",
  footstepDirtRun1: "last_summon_sfx_fs_dirt_r1",
  footstepDirtRun2: "last_summon_sfx_fs_dirt_r2",
  footstepDirtRun3: "last_summon_sfx_fs_dirt_r3",
  footstepDirtRun4: "last_summon_sfx_fs_dirt_r4",
  footstepDirtRun5: "last_summon_sfx_fs_dirt_r5",
} as const;
